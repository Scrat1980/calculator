...
class View
{
    ...
    ';
        ...
        $instruction = 'Эта программа выполнит арифметические действия, которые будут указаны в поле "Действия" через разделитель, который нужно указать в поле "Разделитель". Сначала введите разделитель. Он не должен быть пустым и не должен совпадать ни с одним из символов: "+", "-", "*", "/". Затем введите строку действий через разделитель.';
